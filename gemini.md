...
## 1. 개발 환경 (Environment)
- **Node.js 24 Default**: 프로젝트의 기본 개발 및 빌드 환경은 항상 **Node.js 24**를 표준으로 사용합니다. CI/CD (GitHub Actions 등) 파이프라인 구성 시에도 Node.js 24 버전을 강제(`FORCE_JAVASCRIPT_ACTIONS_TO_NODE24=true`)하거나 명시하여 구버전 지원 중단으로 인한 오류를 방지합니다.
